import { Component, OnInit, AfterViewInit, NgZone, OnDestroy, Input, SimpleChanges, OnChanges } from '@angular/core';
import * as am4core from '@amcharts/amcharts4/core';
import * as am4charts from '@amcharts/amcharts4/charts';
import am4themes_animated from '@amcharts/amcharts4/themes/animated';
import { WebUtil } from 'src/app/framework/webUtil';
import { DataService } from 'src/app/comService/data.service';
...
export class GraphComponent implements OnInit, AfterViewInit, OnDestroy, OnChanges {
  ...
  ngOnInit() {
    this.subscription = timer(0, 10000).pipe(
      switchMap(() => this.dataService.readData())
    ).subscribe(result => this.webUtil.pushData(result));
  }
